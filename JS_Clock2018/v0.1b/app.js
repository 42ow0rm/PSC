...
const _Background_color = 'white';
const _Board_off_color = 'white';
const _Board_on_color = 'black';

function clearBoard(){
    let all_items = document.getElementsByTagName('td');
    for(let i = 0; i < all_items.length; i++){
        all_items[i].style.color = _Board_off_color;
    }
}
...
function printOnBoard(ClassName = ''){
    ...
    for(let i = 0; i < getObj.length; i++){
        getObj[i].style.color = _Board_on_color;
    }
}
...
document.body.style.backgroundColor = _Background_color;
startTime();
